...
ALTER TABLE shop ADD CONSTRAINT UK_h4rqgjwnqidx6mvj4i22dxwxe UNIQUE (shopName);
ALTER TABLE item ADD CONSTRAINT FK5k0oem3ypbsnpc0kt1htx37w4 FOREIGN KEY (shopId) REFERENCES shop (id);
ALTER TABLE item ADD CONSTRAINT FKmlrfgone1e43v2q6qrtjvb9jh FOREIGN KEY (user) REFERENCES users (id);
ALTER TABLE score ADD CONSTRAINT FKmldusone9n43v3q6qrtjvb9jh FOREIGN KEY (user) REFERENCES users (id);
